...
<?php
    ...
    if(isset($_POST['att'])){
      ...
      foreach ($_POST['st_status'] as $i => $st_status) {
        ...
        $stat = mysqli_query($con,"insert into attendence(std_id,course,st_status,stat_date) values('$stat_id','$course','$st_status','$dp')");
...
<div class="row">
  ...
  <div class="content">
    ...
    <center><p style="font-size: 30px; color: #1F456E;"><b><?php if(isset($att_msg)) echo $att_msg; if(isset($error_msg)) echo $error_msg; ?></b></p></center> 
    ...
    <form action="" method="post" class="form-horizontal col-md-6 col-md-offset-3">
     ...
     <div class="form-group">
               ...
               <!-- <label>Select Batch</label>
                ...
                <input type="text" name="whichbatch" id="input2" placeholder="e.x.2020">
              </div>
               
     <input type="submit" class="btn btn-primary col-md-2 col-md-offset-5" value="Show!" name="batch" /><br>
...
<br>
    ...
    <form action="" method="post">
      ...
      <div class="form-group">
        ...
        <option  value="dbms">Distributed computing</option>
        <option  value="dbmslab">Database Management System Lab</option>
        <option  value="weblab">Professional practices</option>
        <option  value="os">SE</option>
        <option  value="oslab">Operating System Lab</option>
        <option  value="obm">maths</option>
        <option  value="softcomp">english</option>
              </select>

      </div>
<div  margin-left: 900px>
    <table class="table table-stripped"margin-left: 50px>
      <thead>
        <tr>
