...
<header>
  ...
  <img src="uni.png" alt="picture here" width="100" height="100">
  

</header>

<h1 style="font-family: italic;"><b>Login</b></h1>
...
<div class="content">
	<div class="row">
		...
		<form method="post" class="form-horizontal col-md-6 col-md-offset-3">
			...
			<div class="col-sm-7">
			  <label>
                <img src="student.png" width="100px" height="70px"><br>
			    <input type="radio" name="type" id="optionsRadios1" value="student" checked> 
                  Student
			  </label>
			  	  <label>
                    <img src="teacher.jpg" width="120px" height="80px"><br>
			    <input type="radio" name="type" id="optionsRadios1" value="teacher"> Teacher
			  </label>
			  <label>
                  <img src="admin.jpg" width="100px" height="70px"><br>
...
<div text-align: center >
			<input type="submit" class="btn btn-primary col-md-3 col-md-offset-5" width="40px"  value="Login" name="login" >
</div>
		</form>
	</div>
</div>
...
<p><strong>If you don't have any account, <a href="signup.php"><input type="button" value="Signup" class="btn btn-success"></a> here</strong></p>
