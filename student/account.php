...
if(!$sid){
  ...
  //reading students information to database table "students"
  $result = mysql_query("update students set st_name='$_POST[name]',st_password='$_POST[password]',st_batch='$_POST[batch]',st_sem='$_POST[semester]', st_email = '$_POST[email]' where st_id='$sid'");
        ...
        ?>
          ...
          <form method="post" action="" class="form-horizontal col-md-6 col-md-offset-3">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="sr_id"  class="form-control" id="input1" placeholder="enter your student ID. to continue" />
                </div>
            </div>
...
<form action="" method="post" class="form-horizontal col-md-6 col-md-offset-3">
   <table class="table table-striped">
          ...
          <tr>
              <td>Password:</td>
              <td><input type="text" name="password" value="<?php echo $data['st_password']; ?>"></input></td>
          </tr>
