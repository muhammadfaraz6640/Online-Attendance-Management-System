  ...
  try{
    ...
    if(isset($_POST['st'])){
      ...
      //students data insertion to database table "students"
        $result = mysqli_query($con,"insert into students(st_id,st_name,st_password,st_batch,st_sem,st_email) values('$_POST[st_id]','$_POST[st_name]','$_POST[st_password]','$_POST[st_batch]','$_POST[st_sem]','$_POST[st_email]')");
...
<br><br><br>
  <div class="rowtwo" id="students">
  

       <form method="post" class="form-horizontal col-md-6 col-md-offset-3">
        <h4>Add Student's Information</h4>
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Student_ID</label>
          <div class="col-sm-7">
            <input type="text" name="st_id"  class="form-control" id="input1" placeholder="student's id" />
          </div>
      </div>

      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Student_Name</label>
          <div class="col-sm-7">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="password" name="st_password"  class="form-control" id="input1" placeholder="" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_sem"  class="form-control" id="input1" placeholder="semester ex.7th" />
          </div>
      </div>
        <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Batch</label>
          <div class="col-sm-7">
            <input type="text" name="st_batch"  class="form-control" id="input1" placeholder="batch ex. 2020" />
          </div>
      </div>

      <input type="submit" class="btn btn-primary col-md-2 col-md-offset-8" value="Add Student" name="st" />
    </form>
