  ...
  try{
    ...
    //validation of empty fields
      if(isset($_POST['signup'])){
        ...
        if(empty($_POST['id'])){
          throw new Exception("id cann't be empty.");
        }
        ...
        $result = mysqli_query("insert into admininfo(id,username,password,email,fname,phone,type) values('$_POST[id]','$_POST[uname]','$_POST[pass]','$_POST[email]','$_POST[fname]','$_POST[phone]','$_POST[type]')");
